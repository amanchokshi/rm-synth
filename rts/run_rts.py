...
def make_rts_setup(obs=None, outdir=None, time_stamp=None):
    ...
    with open(f"{outdir}{obs}/{time_stamp}/rts_setup_{obs}.sh", "w+") as outfile:
        ...
        outfile.write("export PYTHONPATH=$PYTHONPATH:/astro/mwaeor/achokshi/software/local_python\n")
...
def make_rts_run(obs=None, outdir=None, time_stamp=None):
    ...
    with open(f"{outdir}{obs}/{time_stamp}/rts_run_{obs}.sh", "w+") as outfile:
